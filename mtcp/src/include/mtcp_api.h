...
int
mtcp_create_app_context(mctx_t mctx, lthread_func_t func, void *arg);
...
int
mtcp_batch_accept(mctx_t mctx, int sockid, struct sockaddr *addr, socklen_t *addrlen, int *sockids, int maxaccepts);

int
mtcp_batch_close(mctx_t mctx, int *sockids, int sockids_len);
