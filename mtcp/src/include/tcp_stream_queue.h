...
#define SQ_LOCK_DESTROY(lock)	thread_spin_destroy(lock)
#define SQ_LOCK(lock)			thread_spin_lock(lock)
#define SQ_UNLOCK(lock)			thread_spin_unlock(lock)
#else
#define SQ_LOCK_INIT(lock, errmsg, action);		\
...
#define SQ_LOCK_DESTROY(lock)	thread_mutex_destroy(lock)
#define SQ_LOCK(lock)			thread_mutex_lock(lock)
#define SQ_UNLOCK(lock)			thread_mutex_unlock(lock)
#endif /* USE_SPIN_LOCK */
