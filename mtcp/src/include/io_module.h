...
#define USE_DPDK_RECV_PKTS_AND_POPULATE
...
typedef struct io_module_func {
	...
	int32_t   (*send_merged_pkts)(struct mtcp_thread_context *ctx, int nif);
	...
	int32_t   (*recv_pkts_and_gettimeofday)(struct mtcp_thread_context *ctx, int ifidx, struct timeval* cur_ts);
	int32_t   (*send_pkts_and_recv_pkts_and_gettimeofday)(struct mtcp_thread_context *ctx, int ifidx, struct timeval* cur_ts);
	int32_t   (*prepare_send_merged_pkts)(struct mtcp_thread_context *ctxt, int ifidx, int num_of_queues);
	int32_t   (*send_merged_pkts_and_recv_pkts_and_gettimeofday)(struct mtcp_thread_context *ctxt, int ifidx, struct timeval* cur_ts);
