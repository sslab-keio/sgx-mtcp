...
#define GET_LOGGER() ((logger *) thread_getspecific(logger_key));
...
typedef struct _logger {
    struct _logger *prev;
    struct _logger *next;
    thread_mutex_t mutex; /* guard for this + *buf */
...
extern thread_key_t logger_key;
...
#define LOGGER_LOG(l, flag, type, ...) (void)0
#else
